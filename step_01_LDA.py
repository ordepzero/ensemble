# -*- coding: utf-8 -*-
"""
Created on Mon Aug 20 00:06:52 2018
...
def execute_svm_train(bases_of_samples,selected_channels,degree,conf,first_index,subdic_name):
    ...
    for test_base_index in range(len(bases_of_samples)):
        ...
        if(False):
            ...
            keep_selected_channels = [1]*n_total_channels
        ...
        while(sum(keep_selected_channels) <= max_channels_selected):
            ...
            if(control_sct):
                ...
                #control_sct = True #DEVE SER TRUE PARA SELECIONAR OS CANAIS
                control_sct = False # SE FOR FALSE ELE SAI NA PRIMEIRA ITERACAO
...
def execute(sel_chan_type,subject,filter_order,highcut,degree=2,subdic_name="",prefix=""): 
    ...
    if(n_bases == 5):
        for cont_bases_of_samples in range(len(bases_of_samples)):
            bases_of_samples[cont_bases_of_samples] = bases_of_samples[cont_bases_of_samples][0:180*8]
...
if __name__ == "__main__": 
    print("INICIO")
    print("VERIFIQUE A VARIAVEL 'control_sct' PARA SELECAO DE CANAIS")
    ...
    subdic_name = "fc_lda_17b_64c_"+subdic_name[5:]+prefix
