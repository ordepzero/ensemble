...
if __name__ == '__main__':
    ...
    for subject in ["A","B"]:
        ...
        for highcut in [10,20]:
            for filter_order in [5]:
                print(subject,highcut,filter_order)
                ...
                print("Separando")
                sps = rf.separate_signals_parts(signal_file," ",size_part)
                print("Filtando")
                ...
                for i in range(nbOfChars):
                    ...
                    first_char_index = i*n_channels*n_signals_char
                    ...
                    for j in range(n_signals_char):
                        ...
                        for k in range(n_channels):
                            samples_signals.append(sps[first_char_index+(k*n_signals_char)+j])
