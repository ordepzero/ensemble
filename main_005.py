            ...
            for coef0 in coef_values:
                for gamma in gamma_values:
                    ...
                    if(test_perf >= current_test_perf):
                        ...
                        current_classifier = classifier.my_svm
...
def execute(sel_chan_type,subject,filter_order,highcut,degree=2,subdic_name=""): 
    #print("Início")
    if(sel_chan_type == 0):
            ...
            for highcut in l_highcut:
                for sel_chan_type in l_sel_chan_type:
                    for degree in l_degree:
                        ...
                        execute(sel_chan_type,subject,filter_order,highcut,degree,subdic_name) # O 0 indica da sub base 0 a 8
