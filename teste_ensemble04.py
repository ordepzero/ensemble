# -*- coding: utf-8 -*-
"""
Created on Tue Jul 10 00:53:31 2018
...
ensembles = load_ensemble(conf,"only_B_07_23")
cont_hits = 0
for i in range(nbOfChars):
    ...
    print("Precited word:",matrix[line_index][column_index],testB[i],matrix_avaliate_result,i,cont_hits)
